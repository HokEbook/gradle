    ...
    public RootComponentState toRootComponent(ConfigurationInternal configuration) {
        ...
        return new RootComponentState() {
            ...
            public LocalVariantGraphResolveState getRootVariant() {
                ...
                LocalVariantGraphResolveState rootVariant = rootComponent.getConfigurationLegacy(configuration);
                if (rootVariant == null) {
                    throw new IllegalArgumentException(String.format("Expected root variant '%s' to be present in %s", configuration.getName(), componentIdentifier));
                }
                return rootVariant;
            }
        };
